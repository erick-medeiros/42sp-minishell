...
FILES += $(addprefix executor/, executor.c expansion.c redirect.c)
FILES += $(addprefix executor/, pipeline.c search.c errors.c subshell.c)
...
FILES += $(addprefix utils/, cleanup.c command.c free.c list.c minishell.c)
