...
FILES += $(addprefix expander/, env_conv.c env_utils.c expander.c filename.c pathname.c quotes.c)
...
FILES += $(addprefix utils/, cleanup.c command.c error.c free.c list.c minishell.c queue.c stack.c tree.c utils.c)
