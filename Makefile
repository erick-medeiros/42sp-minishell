...
FILES += lexer/lexer.c
FILES += lexer/states/append.c
FILES += lexer/states/double_quote.c
FILES += lexer/states/end.c
FILES += lexer/states/input.c
FILES += lexer/states/output.c
FILES += lexer/states/pipe.c
FILES += lexer/states/single_quote.c
FILES += lexer/states/start.c
FILES += lexer/states/word.c
