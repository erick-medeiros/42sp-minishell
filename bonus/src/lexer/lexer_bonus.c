...
static t_lex_state	get_next_state(size_t idx, t_node **tokens,
	t_lex_state st, t_val_info *vi)
{
	t_lex_state	(*f)(size_t, t_node **, t_val_info *);
	t_lex_state	(* const state_funcs[])(size_t, t_node **, t_val_info *) = {
		handle_amp_state, handle_and_state, handle_append_state,
		handle_brace_state, NULL, NULL, handle_dquote_state,
		handle_heredoc_state, NULL, handle_input_state, NULL,
